...
public abstract class TcpMsgRoot {
	protected static TaskExecutor teHandler;
	protected static JedisPool jedisPool;
	protected static Channel sessionCh;
	...
	public static void setHandler(TaskExecutor handler) {
		TcpMsgRoot.teHandler = handler;
	}
	
	//현재 연결된 소켓에 메시지를 보내기 위한 랩핑함수
	protected int tcpWrite(String msg) {
		...
		try {
			...
			teHandler.packetHandler.cf.channel().writeAndFlush(buf).sync();
